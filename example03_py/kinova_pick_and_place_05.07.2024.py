...
# Use Screenshot_Taker_timer.py and Camera_Calibration.py to get this values. See Readme
...
# Change here and Check
# vision_sensor_focus_action_filepath = r'C:\Users\Admin\Desktop\Pick_Place_Demo\Python Pick
# and Place Files\focus_350.py'
vision_sensor_focus_action_filepath = os.getcwd() + r"\instrinsics.py"
...
def check_for_end_or_abort(e):
    """
    Abstract: Return a closure checking for END or ABORT notifications
...
def controller_vision_find(switch, global_return_values, coordinates):
    ...
    subprocess.run(['python', vision_sensor_focus_action_filepath])  # Check
...
def pick_up_L(t, coordinates, angles):
    ...
    if angles["large"] is not None:
        ...
        with utilities.DeviceConnection.createTcpConnection(
            ...
            close_gripper(router, router_real_time, 0.057)
